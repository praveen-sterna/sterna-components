...
class CustomAppBar extends StatelessWidget implements PreferredSize{
  ...
  const CustomAppBar({Key? key, required this.title, this.centerTitle, this.isLeading, this.leadingIcon, this.bgColor, this.actions}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return AppBar(
      ...
      leading: (isLeading ?? true) ? IconButton(
        ...
        icon: Icon(leadingIcon ?? Icons.keyboard_backspace_rounded, color: Colors.white,),
      ) : null,
      actions: actions,
